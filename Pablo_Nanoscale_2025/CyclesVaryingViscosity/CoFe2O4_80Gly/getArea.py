...
for filename in files:
    if " "+str(fieldIntensity)+"kAm" in filename or " "+str(fieldIntensity)+" kAm" in filename or "-"+str(fieldIntensity)+"kAm" in filename or "-"+str(fieldIntensity)+" kAm" in filename:
